<h1 align="center">
  <a href="https://domusai.ai">
    <picture>
      ...
      <img alt="Domus AI" src=".github/assets/logo.svg" width="600">
    </picture>
  </a>
</h1>

<p align="center">
  <em><b>Domus AI</b> — the AI-powered shared housing marketplace where listing a room is as easy as posting a photo and finding one is as fast as asking a question.<br>
  Just <b>move in</b>.</em>
</p>
...
**Domus AI fixes this.** An AI-powered marketplace where hosts list rooms in minutes, tenants find matches through natural conversation, and everyone pays weekly instead of drowning in first-month-last-month-deposit math.

**Everything just works.** You sign up, and Atlas — your AI assistant — handles the rest, from property intelligence to encrypted vault storage for your private data.
...
Just ask Atlas. *"I need a furnished room near downtown Tampa under $250 a week"* — he understands location, budget, amenities, and preferences. No dropdowns. No filter menus. Just a conversation with your AI assistant.
...
**11.2M+ searchable properties** across Florida and expanding. Autocomplete across **154M+ US addresses**. It's fast.
...
Every property page comes with **Atlas** — your personal AI assistant. He knows the property, the neighborhood, and the surrounding area. Atlas is just there, ready to help.
...
Talk to **Claude, GPT, Gemini, Grok**, or a **local model**. Switch providers mid-conversation. Every response streams in real-time — no waiting for a spinner to finish. Full conversation history, encrypted in your vault.
...
- **Automatic payment collection** — weekly, handled for you
...
- **Privacy-conscious users** who want zero-knowledge encryption that just works

---

<p align="center">
  <img src=".github/assets/atlas.png" width="100" alt="Atlas">
  <br><br>
